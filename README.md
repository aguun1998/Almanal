[README(4).md](https://github.com/user-attachments/files/31157768/README.4.md)
# ALMANAL (알만알)
...
The Riichi Mahjong example under `HUMAN_RT_H23.md` shows this style of iterative redesign on a concrete decision procedure.
...
For the initial public release, the repository uses a flat layout:
...
This keeps the first release simple. Subdirectories can be introduced later if the number of versions, examples, benchmarks, or implementations grows.
...
1. Read this README.
2. Read **ALMANAL_13.3_COMPACT_KERNEL.md**.
3. Open only the relevant sections of **ALMANAL_13.3_STANDARD_LIBRARY.md**.
4. Read **ALMANAL_13.3_COMPACTION_REGRESSION.md** if you want to audit the 12.3 → 13.3 transition.
5. Read **HUMAN_RT_H23.md** if you want a concrete application.
6. Read **ALMANAL_12.3_HISTORICAL_AUDIT.md** only if you want to trace why a rule exists.
